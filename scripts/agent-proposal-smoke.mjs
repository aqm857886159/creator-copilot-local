...
const { ApiMartClient } = await import("../dist-electron/packages/providers/src/index.js");
const { ProviderEditAgentRuntime } = await import("../dist-electron/packages/agent-runtime/src/index.js");
...
const provider = new ApiMartClient({ apiKey: requireEnvironment("APIMART_API_KEY"), baseUrl: process.env.APIMART_BASE_URL ?? "https://api.apimart.ai" });
const agent = new ProviderEditAgentRuntime(provider, process.env.AI_EDIT_MODEL ?? "gpt-5-nano");
